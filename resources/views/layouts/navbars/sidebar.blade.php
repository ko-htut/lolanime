<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">
            <img src="{{ asset('argon') }}/img/brand/lol.png" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('argon') }}/img/brand/lol.png">
                        </a>
                    </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('category.index') }}">
                        <i class="ni ni-planet text-blue"></i> Genres
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('language.index') }}">
                        <i class="ni ni-planet text-blue"></i> Language
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('movie.index') }}">
                        <i class="ni ni-pin-3 text-orange"></i> Movie
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('series.index') }}">
                        <i class="ni ni-key-25 text-info"></i> Series
                    </a>
                </li>
                <li class="nav-item">
