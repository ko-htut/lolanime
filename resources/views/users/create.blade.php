                        ...
                        <form method="post" action="{{ route('admin.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" class="form-control form-control-alternative" placeholder="Name" required autofocus>
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label">Email</label>
                                    <input name="email" class="form-control form-control-alternative" placeholder="Email" required>
                                </div>
